...
void compare(){
    ...
    Cell_t *array = malloc(10000*sizeof(Cell_t));
    start = clock();
    ...
    printf("Time needed for creating an array of 10000 is %lf\n",(double)(end - start));
    ...
    printf("Time needed for creating a stack of 10000 is %lf\n",(double)(end - start));

    start = clock();
    free(array);
    end = clock();
    printf("Time needed for freeing an array of 10000 is %lf\n",(double)(end - start));

    start = clock();
    wipe(stack);
    end = clock();
    printf("Time needed for freeing a stack of 10000 is %lf\n",(double)(end - start));
}
